...
public class ControllerInputs {
    ...
    public static boolean isGamepad1_right_bumper_pressed() { return gamepad1_right_bumper_pressed;}

    public static boolean isGamepad1_left_bumper_pressed() {
        return gamepad1_left_bumper_pressed;
    }

    public static boolean isGamepad1_left_stick_button_pressed() { return gamepad1_left_stick_button_pressed; }

    public static boolean isGamepad1_right_stick_button_pressed() { return gamepad1_right_stick_button_pressed;}
    ...
    public static boolean isGamepad2_right_bumper_pressed() {return gamepad2_right_bumper_pressed;}

    public static boolean isGamepad2_left_bumper_pressed() {
        return gamepad2_left_bumper_pressed;
    }

    public static boolean isGamepad2_left_stick_button_pressed() {return gamepad2_left_stick_button_pressed;}

    public static boolean isGamepad2_right_stick_button_pressed() {return gamepad2_right_stick_button_pressed;}
