...
@Disabled
public abstract class AutonomousMovement extends TunableOpMode {
...
//    double armMaxReachPosition = .927;
    ...
    double armState = 0;
    double armServoPosition = armIntakePosition, rotatorServoPosition = rotatorIntakePosition, rotatorGripPosition = rotatorGripIntakePosition;
